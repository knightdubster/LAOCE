...
//THIS PAGE IS SOMETIMES CALLED WITH department and semester variables
//AND SOMETIMES CALLED WITH JUST evalID
//VARIABLES MUST BE GOTTEN BEFORE validateIDorDept.php INCLUDE
...
if(isset($p_evalID)){
	...
	//what department? needed for dept access
	$pattern = '/[0-9.-]/';
	$depart = substr($coursename, 0, 5);//just take first 5 characters
	$departname = preg_replace($pattern,"",$depart);//remove numbers
}elseif(isset($p_department)){
	$semester = $p_semester;
	$department = $p_department;
	$pattern = '/[0-9.-]/';
	//FIND MATCH OF DEPT TO COURSENAME
