...
$query = mysql_query("SELECT * from CourseInfo WHERE semester = '$semester' ORDER BY coursename");
	while($row = mysql_fetch_array($query)){
		if(isset($row['coursename'])){
			...
			echo "<a href='displayScores.php?evalID=" .$evalID . "'>" . $row['coursename'] . "</a> Section: " . $section;
			...
			echo "</div></div>";
			echo "<div class='small'><a href='courseAllSemesters.php?coursename=" . $row['coursename'] . "'>" . $row['coursename'] . " all semesters.</a></div><br/>";
